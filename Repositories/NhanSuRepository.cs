...
namespace Repositories
{
    public class NhanSuRepository
    {
        ...
        public bool EditInformation(string UserID, string newUserName, string newNumber, string newBirth, string newCID, string newEmail, string newAddress, string newGender)
        {
            ...
            try
            {
                ...
                using (conn)
                {
                    ...
                    string queryEdit = "UPDATE NhanSu SET hoVaTen = @UserName, SDT = @Number, namSinh = @Birth, CCCD = @CID, email = @Email, diaChi = @Address, gioiTinh = @Gender WHERE maThanhVien = '" + UserID + "'";
